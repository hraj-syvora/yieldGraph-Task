export const lineGraphData1mo = {
  ...
  const currentYieldData = lineGraphData1mo.datasets[0].data;
const historicalYieldData = lineGraphData1mo.datasets[1].data;

export const barGraphData1mo = {
